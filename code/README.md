...
This directory contains the core logic for the Support Ticket Triage AI Agent. It implements RAG Pipeline using Azure OpenAI to process, analyze, and resolve customer support tickets intelligently.
